...
public class PhotoBrowse extends Activity {
	...
	int[] imgs = new int[] { R.drawable.aaa, R.drawable.bbb, R.drawable.ccc, R.drawable.ddd,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		gv.setAdapter(new BaseAdapter() {
			...
			public View getView(int position, View convertView, ViewGroup parent) {
				...
				p.setLayoutParams(new AbsListView.LayoutParams((int) (getResources()
						.getDisplayMetrics().density * 100), (int) (getResources()
